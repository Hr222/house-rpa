...
用法：
  python -m scripts.rpa.ke_mvp_test
  python -m scripts.rpa.ke_mvp_test --excel
  python -m scripts.rpa.ke_mvp_test --community "绿景虹湾" --area 89.5
"""
...
from app.rpa.platforms.adapters.ke import (
    _get_search_input,
    _human_click,
    _submit_search,
)
from app.rpa.platforms.ke_constants import AREA_SEGMENTS, START_URL
